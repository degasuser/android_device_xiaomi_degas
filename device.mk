...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/permissions/privapp-permissions-mtk-engineermode.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-mtk-engineermode.xml
